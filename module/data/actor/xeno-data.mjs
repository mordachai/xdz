...
export default class XenoData extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      xenoType: new fields.StringField({ required: true, initial: 'drone', choices: ['drone', 'warrior', 'pretorian', 'breeder', 'alpha', 'custom'] }),
      xenoTypeCustom: new fields.StringField({ required: true, blank: true, initial: '' }),
